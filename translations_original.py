...
No answer|אין מענה|נישט געענטפערט
Left a message|הושארה הודעה|איבערגעלאזט א מעסעדזש
Call back|להתקשר שוב|צוריקצורופן
Contacted|נוצר קשר|מען האט גערעדט
Pledged|התחייב|צוגעזאגט
Wrong number|מספר שגוי|פאלשע נומער
...
CATALOG.update({
 ...
 ,'Received this month':{'he':'התקבל החודש','yi':'באקומען דעם חודש'}, 'Lifetime received':{'he':'התקבל לאורך הזמן','yi':'באקומען במשך הזמן'}, 'Lifetime collected':{'he':'סך הכול נאסף','yi':'אלעס אינאיינעם געזאמלט'}, 'Lifetime sent to family':{'he':'סך הכול נשלח למשפחה','yi':'אלעס אינאיינעם געשיקט צו דער משפחה'}, 'Available to pay out':{'he':'זמין לתשלום','yi':'גרייט ארויסצוצאלן'}, 'Approved outstanding':{'he':'מאושר שטרם שולם','yi':'באשטעטיגט און נאך נישט באצאלט'}, 'Paid support':{'he':'סיוע ששולם','yi':'באצאלטע הילף'}, 'Paid organization costs':{'he':'עלויות ארגון ששולמו','yi':'באצאלטע ארגאניזאציע קאסטן'}, 'Enter valid child estimate settings.':{'he':'הזינו הגדרות אומדן ילדים תקינות.','yi':'לייגט אריין גילטיגע קינדער־שאצונג קאנטראָלס.'}, 'Choose valid expense categories.':{'he':'בחרו קטגוריות הוצאה תקינות.','yi':'קלויבט אויס גילטיגע הוצאה קאטעגאריעס.'}, 'Amount ($)':{'he':'סכום ($)','yi':'סכום ($)'}
})
...
Donor name|שם התורם|נאמען פונעם נדבן
Save name|שמירת השם|אפהיטן דעם נאמען
Enter the donor name.|הזינו את שם התורם.|לייגט אריין דעם נאמען פונעם נדבן.
Donor name saved.|שם התורם נשמר.|דער נאמען פונעם נדבן איז אפגעהיטן.
