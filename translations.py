...
_EXTRA = {
    ...
    'Enter the bank information once before creating checks.': {'he': 'הזינו את פרטי הבנק פעם אחת לפני יצירת המחאות.', 'yi': 'לייגט איין די באנק פרטים איין מאל איידער מען מאכט טשעקס.'},
