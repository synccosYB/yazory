...
def test_budget_persistence_validation_and_blank_intake(monkeypatch):
    ...
    values={'csrf':csrf,'name':'Wizard household','intake_version':'1','children_count':'4','rent':'1700.25','food':'','his_income':'0','foodstamps':'yes','foodstamps_amount':'250.75','accounts_json':json.dumps([{'kind':'utility','provider':'Local electric','account':'000123'}]),'assistance_json':json.dumps([{'provider':'Community fund','amount':'150.10'}])}
    ...
    assert edit.status_code==200 and '1700.25' in edit.text and '000123' in edit.text
